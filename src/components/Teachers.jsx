...
export function TeachersSection() {
  ...
  return (
    // This section already has left and right padding (px-4 sm:px-6 md:px-16)
      ...
      >
        ...
        <h2 className="text-4xl md:text-5xl font-bold mb-12 text-center text-white">
          Meet the Teachers <span
            className="text-transparent bg-clip-text bg-gradient-to-r from-blue-900 via-blue-900 to-blue-900"
            style={{}}
          >
        ...
        {/* --- FIX: Changed from Grid to Flexbox for perfect centering --- */}
        <div className="flex flex-wrap justify-center gap-8">
          {teachers.map((teacher, index) => (
            <motion.div
              key={index}
              // --- FIX: Re-added a fixed width for consistency in a flex layout ---
              className="relative h-96 w-80 bg-neutral-800 rounded-xl overflow-hidden shadow-lg border border-transparent"
              ...
              <div className="absolute bottom-0 left-0 right-0 p-5 text-white">
                ...
                <div className="mt-4">
                  ...
                  <div className="flex items-center p-3 bg-white/10 rounded-lg">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-purple-300 mr-3 flex-shrink-0" fill="none" viewBox="0 0 24" stroke="currentColor">
