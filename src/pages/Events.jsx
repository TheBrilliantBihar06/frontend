...
const LoginPage = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      {/* Main Login Section */}
      <div className="flex-grow bg-gradient-to-br from-black via-gray-900 to-black flex items-center justify-center p-4 relative overflow-hidden pt-20">
          ...
          <div className="relative">
            ...
            <div className="relative p-8 space-y-6">
              ...
              <button
                ...
                className="group relative w-full bg-gradient-to-r from-gray-700 via-gray-800 to-gray-900 text-white font-bold py-4 px-6 rounded-2xl shadow-2xl hover:shadow-gray-800/25 transform hover:scale-[1.02] transition-all duration-300 disabled:opacity-70 disabled:cursor-not-allowed overflow-hidden"
              >
                <div className="absolute inset-0 bg-gradient-to-r from-gray-800 via-gray-900 to-black opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
