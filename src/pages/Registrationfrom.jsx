...
// In a real application, you would install axios: npm install axios
import axios from 'axios';
import Navbar from '../components/Navbar';
import Footer from '../components/Footer';
// Main App Component
export default function App() {
  // This useEffect is to load the Razorpay script dynamically.
  useEffect(() => {
     ...
     <Navbar/>
      <div className="max-w-4xl mx-auto">
        <header className="text-center mb-8">
          ...
          <p className="text-lg text-white-600">Online Application Form</p>
        </header>
        <Form />
      </div>
      <Footer/>
...
// The Form component you provided, now completed.
const Form = () => {
    ...
    // Pre-defined data for form fields
    ...
    useEffect(() => {
        const generateApplicationId = async () => {
            try {
                // MOCK API CALL: This is a placeholder for a real API call.
                // const response = await axios.get('/api/application/generate-id');
                // setApplicationId(response.data.applicationId);
                
                // Fallback to client-side generation for demonstration
    ...
    // Determine payment amount based on the selected category.
    useEffect(() => {
    ...
    // Validates the fields for the current step.
    ...
    const nextStep = () => {
        if (validateStep(currentStep)) {
            setCurrentStep(prev => Math.min(prev + 1, 5)); // Changed to 5 to include a final confirmation step
        }
    };
    ...
    const goToStep = (step) => {
        // Allow navigation only to visited steps or the next immediate step
    ...
    try {
      ...
      const options = {
    key: 'rzp_live_RB6T09MaKOWQbW', // <-- YOUR LIVE KEY HERE
    amount: data.amount,
    currency: 'INR',
...
const submitForm = async () => {
    ...
    try {
        ...
        // Include payment amount for record
        if (paymentRequired) {
        ...
        setCurrentStep(5); // Move to confirmation screen
    ...
    // Renders the progress bar at the top of the form.
    ...
    // Renders Step 1: Personal Details
    const renderStep1 = () => (
        <div className="p-6">
    ...
    // Renders Step 2: Contact Details
    const renderStep2 = () => (
        <div className="p-6">
    ...
    // Renders Step 3: Educational Details
    const renderStep3 = () => (
        <div className="p-6">
    ...
    // Renders Step 4: Document Upload and Payment
    const renderStep4 = () => (
        <div className="p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                ...
                <div>
                    ...
                    <input type="file" name="photo" onChange={handleInputChange} accept="image/jpeg, image/png" className="w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-green-50 file:text-green-700 hover:file:bg-green-100"/>
                ...
                <div>
                    ...
                    <input type="file" name="govtId" onChange={handleInputChange} accept="image/jpeg, image/png, application/pdf" className="w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-green-50 file:text-green-700 hover:file:bg-green-100"/>
    ...
    const renderConfirmation = () => (
        <div className="p-8 text-center">
            ...
            <p className="text-gray-600 mb-4">Your application ID is <span className="font-semibold text-gray-900 bg-gray-200 px-2 py-1 rounded">{applicationId}</span>.</p>
